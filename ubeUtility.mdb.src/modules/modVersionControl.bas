...
'
' msaccess-vcs-integration add in required. Download from github:
'
...
'---------------------------------------------------------------------------------------
'
Public Sub InitializeVersionControlSystem(Optional ByVal blnUseVersionControl As Boolean = True)
...
'---------------------------------------------------------------------------------------
'
Private Sub LoadVersionControl(ByVal blnUseVersionControl As Boolean, ByRef strLibraryPath As String, ByVal strLibraryFile As String, ByVal strLibraryName As String, ByRef colParams As Collection)
    
    Const VB_PROJECT As Long = 1
